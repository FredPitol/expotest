...
export default function SPR_App() {
  return (
    <View style={styles.container}>
      {/*<SPR_Botao min={1} max={65} />*/}
      {/*<Pai />*/} {/* comunicacao direta */}
      <PaiInd /> {/* comunicacao indireta *sa/}
      {/*<MinMax min={10} max={90}/>*/}
      {/*}
      <Aleatorio min={1} max={60} /> 
      <Aleatorio min={20} max={50} /> 
      <Aleatorio min={100} max={6000} /> */}
      {/*} <Titulo principal="Cadastro Produto" secundario="cadastro item"/> 
      <Titulo principal="Cadastro Produto" secundario="cadastro item"/> 
      <Titulo principal="Cadastro Produto" secundario="cadastro item"/> */}
      {/* <SPR_Botao min={10} max={100}/> */}
      {/*<Contador inicial={100} passo={10} /> */}
      {/*<Pai /> */} {/*comunicao direta: Pai->Filho*/}
      {/*<PaiInd /> */} {/*comunicao Indireta: Filho->Pai*/}
      {/* < TextINPUT/> */}
    </View>
  );
}
